...
const projects = [
  {
    ...
    description:
      "A clean and responsive web platform built for a local agricultural agency to showcase its products and services. The site emphasizes a modern design, product listing, and smooth navigation using Next.js and Tailwind CSS. Optimized for performance and mobile-friendly access, this project serves as a digital presence for the agency.",
  ...
  },
  {
    ...
    description:
      "A fully responsive food delivery app seamlessly integrating Swiggy’s live API. Built from the ground up using React, this app leverages modern web development techniques, ensuring a smooth user experience and optimized performance.",
    tags: [
      "React",
      "React Redux",
      "React Router",
  ...
  },
  {
    ...
    title: "Youtube Clone",
    description:
      "A video-sharing platform replicating core YouTube functionality, featuring infinite scroll, and lazy loading. Utilizes responsive design with react-bootstrap.",
    tags: [
      "React",
      "React Redux",
      "React Router",
